...
"""
********************************************************************************
* MODULE 	: TXT_to_EXCELparser.py
* FUNCTION 	: This script parse text file to excel.
* PROGRAMMER 	: Vishal Gautam
* DATE(ORG) 	: 10/02/2016
* REMARKS 	: This assumes that the xlrd & xlwt setups were already installed.
